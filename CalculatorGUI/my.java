...
for syntax:
there should be no spaces in the middle of forming numbers
there can only be operators following numbers, no consecutive numbers.
no consecutive actual operators
no operators following (
no operators preceding )
3 + 3 */
class my{
    ...
    static String e = "(  -3.02+1)^(1+1)";
    static int i = 0;
    static boolean wasNumber;
