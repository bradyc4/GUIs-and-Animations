...
public class ActionTester
{
  public static void main(String[] args)
  {
     JFrame frame = new JFrame();       //create a new Jframe window, equipped with borders
                                        //and buttons for min, max and exit. The window can be
                                        //programmed for "action" in carrying out some "event"
    
     final int FIELD_WIDTH = 50;        //25 pixel width  
     final JTextField textField = new JTextField(FIELD_WIDTH);  //create a new textfield
     ...
     */
     ...
     /*Clicking the button is an "event" (or "event object"),
      which is sent to an object called a
     ...
     */
     ...
     /*The "add" method can be used to add components,
